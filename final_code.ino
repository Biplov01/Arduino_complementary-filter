...
double linvela, linvelb, linvelc, linaccel_X, linaccel_Y, linaccel_Z;
...
dx = (accel_x/2) * second * second;
dy = (accel_y/2) * second * second;
dz = (accel_z/2) * second * second;
...
velocityz = (accel_z * second);
     ...
     Serial.print(" ");
     delay(500);*/
  Serial.println("displacement in x");
  Serial.print(dx);
 ...
 /* dx = (dx+((((accel_x) * (accel_x))/32768)/2.0)*second);
    ...
    Serial.print(" ");
     ...
     linvela = accel_x * second;
     linvelb = accel_y * second;
     linvelc = accel_z * second;
     linaccel_X = linvela/second;
     linaccel_Y = linvelb/second;
     linaccel_Z = linvelc/second;
   Serial.println(" linear accelerations in X, Y, Z");

     Serial.print(linaccel_X);
    Serial.print(" ");
    Serial.print(linaccel_Y);
    Serial.print(" ");
    Serial.print(linaccel_Z);
    Serial.print(" ");
     Serial.print(" m/s^2");
